    ...
    <head>
        ...
        <script>
            ...
            function importMdb() {
                ...
                var controllers = ['<?= site_url("/import/mdb_checkinout"); ?>',
                    '<?= site_url("/import/mdb_userinfo"); ?>',
                    '<?= site_url("/import/mdb_departments"); ?>',
                    '<?= site_url("/import/clean_directory"); ?>',
                    '<?= site_url("/import/mdb_process"); ?>'];
                var interactive = [{divid: "loading_checkinout", before: "Import Attendance Data", after: "Attendance Data Imported"},
                            {divid: "loading_userinfo", before: "Import User Data", after: "User Data Imported"},
                            {divid: "loading_departments", before: "Import Department Data", after: "User Department Imported"},
                            {divid: null},
                            {divid: "process_data", before: "Processing Data", after: "Importing Data Succesfull"}];
